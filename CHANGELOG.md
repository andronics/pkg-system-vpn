...
All notable changes to @system/vpn will be documented in this file.
...
- Declared external command requirements: curl, dmenu, nordvpn, systemctl
...
- Package naming now includes collection scope: `@system/vpn`
